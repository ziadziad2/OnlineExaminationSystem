...
<html>
    ...
    <sql:setDataSource driver="com.mysql.cj.jdbc.Driver" url="jdbc:mysql://localhost:3306/ejproj?useSSL=false&serverTimezone=UTC" user="root" password="root"></sql:setDataSource>
        <sql:query var="mcq">
